<script lang="ts">
	import { X, FileText, Highlighter, ChevronRight, ChevronLeft, Plus, Trash, MessageSquareText } from 'lucide-svelte';
...
<AddTag 
    ...
    resource={view === "papers" ? papers[selectedPaperIndex!] : highlights[selectedHighlightIndex!]}
/>
...
<DeleteResource
    ...
    filteredTags={filteredTags}
    resource={view === "papers" ? papers[selectedPaperIndex!] : highlights[selectedHighlightIndex!]}
    resources={view === "papers" ? papers : highlights}
    type={view === "papers" ? "paper" : "highlight"}
/>
